...
KIND_VERIFICATION_INFRA_ERROR = "workflow.verification_infra_error"
...
KIND_TASK_CANCELLED = "workflow.task_cancelled"
KIND_FOREMAN_OVERRIDE = "workflow.foreman_override"
