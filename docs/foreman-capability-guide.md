...
| `E_COVERS_UNKNOWN_FLOW` | Source token reference.<br>f"task '{task.id}' covers flow '{flow_id}' which is not declared in critical_flows or forbidden_flows" | `src/cccc/ralph/validation_rules/coverage.py:1019`<br>`src/cccc/ralph/validation_rules/coverage.py:1020` |
| `E_COVERS_UNKNOWN_TASK` | Source token reference.<br>f"task '{task.id}' covers unknown task '{covered_id}'" | `src/cccc/ralph/validation_rules/structural.py:145`<br>`src/cccc/ralph/validation_rules/structural.py:146` |
| `E_COVERS_WITHOUT_DEP_ORDER` | Source token reference.<br>f"task '{task.id}' covers '{covered_id}' but '{covered_id}' is not in its transitive dependency closure" | `src/cccc/ralph/validation_rules/structural.py:157`<br>`src/cccc/ralph/validation_rules/structural.py:158` |
| `E_CRITICAL_ENTRYPOINT_UNOWNED` | Source token reference.<br>message | `src/cccc/ralph/validation_rules/coverage.py:509`<br>`src/cccc/ralph/validation_rules/coverage.py:510` |
| `E_CRITICAL_FLOW_ENTRYPOINT_UNOWNED` | Source token reference.<br>message | `src/cccc/ralph/validation_rules/coverage.py:576`<br>`src/cccc/ralph/validation_rules/coverage.py:577` |
| `E_CRITICAL_FLOW_LEVEL_TOO_WEAK` | Source token reference.<br>f"critical flow '{flow.id}' requires {flow.required_verification_level} but best coverage is {actual_name}" | `src/cccc/ralph/validation_rules/coverage.py:720`<br>`src/cccc/ralph/validation_rules/coverage.py:721` |
| `E_CRITICAL_FLOW_UNCOVERED` | Source token reference.<br>f"[deferred] critical flow '{flow.id}' is not covered by any task's verification"<br>f"[suppress_flows] critical flow '{flow.id}' is not covered by any task's verification"<br>f"critical flow '{flow.id}' is not covered by any task's verification" | `src/cccc/ralph/validation_rules/coverage.py:1166`<br>`src/cccc/ralph/validation_rules/coverage.py:528`<br>`src/cccc/ralph/validation_rules/coverage.py:529`<br>`src/cccc/ralph/validation_rules/coverage.py:539`<br>`src/cccc/ralph/validation_rules/coverage.py:540`<br>`src/cccc/ralph/validation_rules/coverage.py:550`<br>`src/cccc/ralph/validation_rules/coverage.py:551`<br>`src/cccc/ralph/validation_rules/coverage.py:715` |
| `E_CYCLE_DETECTED` | Template reference not found in scanned rule sources. | `plans/_template.yaml:template` |
| `E_DEP_CYCLE` | Source token reference.<br>f"dependency cycle detected involving: {', '.join(cycle)}" | `src/cccc/ralph/validation_rules/structural.py:93`<br>`src/cccc/ralph/validation_rules/structural.py:94` |
| `E_DEP_SELF` | Source token reference.<br>f"task '{t.id}' depends on itself" | `src/cccc/ralph/validation_rules/structural.py:83`<br>`src/cccc/ralph/validation_rules/structural.py:84` |
| `E_DEP_UNKNOWN` | Source token reference.<br>f"task '{t.id}' depends on unknown task '{dep}'" | `src/cccc/ralph/validation_rules/structural.py:72`<br>`src/cccc/ralph/validation_rules/structural.py:73` |
| `E_DUPLICATE_FLOW_ID` | Source token reference.<br>f"duplicate critical_flow id '{flow.id}'" | `src/cccc/ralph/validation_rules/coverage.py:1084`<br>`src/cccc/ralph/validation_rules/coverage.py:1085` |
| `E_DUPLICATE_FORBIDDEN_FLOW_ID` | Source token reference.<br>f"duplicate forbidden_flow id '{flow.id}'" | `src/cccc/ralph/validation_rules/coverage.py:1098`<br>`src/cccc/ralph/validation_rules/coverage.py:1099` |
| `E_DUPLICATE_INVARIANT_NAME` | Source token reference.<br>f"duplicate registration_invariant name '{inv.name}'" | `src/cccc/ralph/validation_rules/coverage.py:1112`<br>`src/cccc/ralph/validation_rules/coverage.py:1113` |
| `E_DUPLICATE_TASK_ID` | Source token reference.<br>f"duplicate task id '{t.id}'" | `src/cccc/ralph/validation_rules/structural.py:60`<br>`src/cccc/ralph/validation_rules/structural.py:61` |
| `E_FORBIDDEN_FLOW_LEVEL_TOO_WEAK` | Source token reference.<br>f"forbidden flow '{flow.id}' requires {flow.required_verification_level} but best coverage is {actual_name}" | `src/cccc/ralph/validation_rules/coverage.py:926`<br>`src/cccc/ralph/validation_rules/coverage.py:927` |
| `E_FORBIDDEN_FLOW_UNCOVERED` | Source token reference.<br>f"[deferred] forbidden flow '{flow.id}' has no negative test covering it"<br>f"forbidden flow '{flow.id}' has no negative test covering it" | `src/cccc/ralph/validation_rules/coverage.py:904`<br>`src/cccc/ralph/validation_rules/coverage.py:905`<br>`src/cccc/ralph/validation_rules/coverage.py:915`<br>`src/cccc/ralph/validation_rules/coverage.py:916` |
| `E_MISSING_CLAIMED_PATHS` | Source token reference.<br>f"task '{t.id}' has no claimed_paths" | `src/cccc/ralph/validation_rules/structural.py:177`<br>`src/cccc/ralph/validation_rules/structural.py:178` |
| `E_MISSING_INTEGRATION_SPINE` | Source token reference.<br>f'plan has {len(plan.tasks)} tasks but no task provides integration/e2e verification covering multiple tasks' | `src/cccc/ralph/validation_rules/structural.py:514`<br>`src/cccc/ralph/validation_rules/structural.py:515` |
| `E_MISSING_VERIFICATION` | Source token reference.<br>f"task '{t.id}' has no verification defined" | `src/cccc/ralph/validation_rules/structural.py:185`<br>`src/cccc/ralph/validation_rules/structural.py:186` |
| `E_MOCK_TEST_MISSING_NAME` | Source token reference.<br>f"task '{t.id}' has a mock_test with empty name" | `src/cccc/ralph/validation_rules/coverage.py:855`<br>`src/cccc/ralph/validation_rules/coverage.py:856` |
| `E_MOCK_TEST_MISSING_VERIFY_COMMAND` | Source token reference.<br>f"task '{t.id}' mock_test '{mt.name}' has no verify_command" | `src/cccc/ralph/validation_rules/coverage.py:862`<br>`src/cccc/ralph/validation_rules/coverage.py:863` |
| `E_MODULE_DUPLICATE_ID` | Source token reference.<br>f"task '{task.id}' has duplicate module id '{mod.id}'" | `src/cccc/ralph/validation_rules/structural.py:703`<br>`src/cccc/ralph/validation_rules/structural.py:711`<br>`src/cccc/ralph/validation_rules/structural.py:712` |
| `E_MODULE_UNKNOWN_DEP` | Source token reference.<br>f"task '{task.id}' module '{mod.id}' depends on unknown module '{dep}'" | `src/cccc/ralph/validation_rules/structural.py:703`<br>`src/cccc/ralph/validation_rules/structural.py:722`<br>`src/cccc/ralph/validation_rules/structural.py:723` |
| `E_NO_CROSS_TASK_VERIFICATION` | Source token reference.<br>f'plan has {len(plan.tasks)} tasks but no integration/e2e verification covers multiple tasks' | `src/cccc/ralph/validation_rules/coverage.py:85`<br>`src/cccc/ralph/validation_rules/coverage.py:86` |
| `E_UNCOVERED_REQUIRED_ISSUE` | Source token reference.<br>f"required issue '{issue_id}' is not addressed by any task" | `src/cccc/ralph/validation_rules/coverage.py:1169`<br>`src/cccc/ralph/validation_rules/coverage.py:776`<br>`src/cccc/ralph/validation_rules/coverage.py:777` |
| `E_VERIFICATION_SHALLOW_CRITICAL` | Source token reference. | `src/cccc/ralph/validation_rules/coverage.py:146` |
...
| `H_DUPLICATE_ISSUE_ADDRESS` | Source token reference.<br>f"issue '{issue_id}' is addressed by multiple tasks: {', '.join(sorted(task_ids))}" | `src/cccc/ralph/validation_rules/coverage.py:823`<br>`src/cccc/ralph/validation_rules/coverage.py:824` |
| `H_MOCK_TESTS_ON_RALPH_MODE` | Source token reference.<br>f"task '{t.id}' has mock_tests but verification_mode='ralph'; mock_tests only run in agent/challenge mode" | `src/cccc/ralph/validation_rules/coverage.py:844`<br>`src/cccc/ralph/validation_rules/coverage.py:845` |
| `H_SUPPRESS_UNUSED` | Source token reference.<br>f"suppress_codes entry '{code}' did not match any emitted issue" | `src/cccc/ralph/validation_rules/coverage.py:1146`<br>`src/cccc/ralph/validation_rules/coverage.py:1147` |
| `H_VERIFICATION_COMMAND_DEAD` | Source token reference.<br>f"task '{task.id}' verification.command is ignored in favor of structured checks" | `src/cccc/ralph/validation_rules/coverage.py:192`<br>`src/cccc/ralph/validation_rules/coverage.py:193` |
...
| `W_AUTH_TIMING_UNSAFE` | Source token reference. | `src/cccc/ralph/security_recipes.py:47` |
| `W_BATCH_E2E_NO_COMMAND` | Source token reference.<br>f"plan has {dep_layers} dependency layers but no batch_e2e_command — cross-task integration won't be verified between batches" | `src/cccc/ralph/validation_rules/coverage.py:1307`<br>`src/cccc/ralph/validation_rules/coverage.py:1317`<br>`src/cccc/ralph/validation_rules/coverage.py:1318` |
...
| `W_COVERS_CLAIM_UNVERIFIABLE` | Source token reference.<br>f"task '{task.id}' covers '{covered_id}' but its verification command does not reference any claimed_paths of '{covered_id}'" | `src/cccc/ralph/validation_rules/coverage.py:437`<br>`src/cccc/ralph/validation_rules/coverage.py:438` |
| `W_COVERS_NOT_EXERCISED` | Source token reference.<br>f"task '{task.id}' covers '{covered_id}' but its verification does not reference the covered paths" | `src/cccc/ralph/validation_rules/coverage.py:216`<br>`src/cccc/ralph/validation_rules/coverage.py:217` |
| `W_CRITICAL_FLOW_NO_ENTRYPOINTS` | Source token reference.<br>f"critical flow '{flow.id}' has no entrypoints declared" | `src/cccc/ralph/validation_rules/coverage.py:1130`<br>`src/cccc/ralph/validation_rules/coverage.py:1131` |
| `W_CRITICAL_FLOW_WORKER_ONLY_VERIFICATION` | Source token reference.<br>f"task '{task.id}' claims critical flow entrypoints but uses verification_mode='{task.verification_mode}' instead of agent/challenge" | `src/cccc/ralph/validation_rules/coverage.py:743`<br>`src/cccc/ralph/validation_rules/coverage.py:744` |
| `W_CROSS_BOUNDARY_WITHOUT_GLUE` | Source token reference.<br>f"task '{t.id}' depends on '{dep_id}' across different path boundaries, but no integration/e2e verification covers both" | `src/cccc/ralph/validation_rules/structural.py:492`<br>`src/cccc/ralph/validation_rules/structural.py:493` |
...
| `W_DISCONNECTED_COMPONENTS` | Source token reference.<br>f'plan has {len(components)} disconnected task groups' | `src/cccc/ralph/validation_rules/structural.py:104`<br>`src/cccc/ralph/validation_rules/structural.py:105` |
...
| `W_EMPTY_ACCEPTANCE` | Source token reference.<br>f"task '{t.id}' has no acceptance_criteria" | `src/cccc/ralph/validation_rules/structural.py:193`<br>`src/cccc/ralph/validation_rules/structural.py:194` |
| `W_FINDING_REF_INCOMPLETE` | Source token reference.<br>f"finding_ref '{ref.id}' is missing mitigation"<br>finding_ref is missing id | `src/cccc/ralph/validation_rules/coverage.py:947`<br>`src/cccc/ralph/validation_rules/coverage.py:948`<br>`src/cccc/ralph/validation_rules/coverage.py:954`<br>`src/cccc/ralph/validation_rules/coverage.py:955` |
| `W_FINDING_REF_UNKNOWN_ENFORCER` | Source token reference.<br>f"finding_ref '{ref.id}' references unknown enforcer '{enforcer}'" | `src/cccc/ralph/validation_rules/coverage.py:963`<br>`src/cccc/ralph/validation_rules/coverage.py:964` |
| `W_FLOW_OWNER_NO_VERIFICATION` | Source token reference.<br>f"task '{task.id}' claims entrypoint '{entrypoint}' of flow '{flow.id}' but doesn't verify the flow" | `src/cccc/ralph/validation_rules/coverage.py:683`<br>`src/cccc/ralph/validation_rules/coverage.py:684` |
| `W_FLOW_SEGMENT_UNOWNED` | Source token reference.<br>f"task '{task.id}' covers flow '{flow.id}' but doesn't claim any of its entrypoints" | `src/cccc/ralph/validation_rules/coverage.py:666`<br>`src/cccc/ralph/validation_rules/coverage.py:667` |
| `W_GLOBAL_WRITE_CLAIM` | Source token reference.<br>f"task '{t.id}' claims global write ('/') — blocks all parallel tasks" | `src/cccc/ralph/validation_rules/structural.py:214`<br>`src/cccc/ralph/validation_rules/structural.py:215` |
...
| `W_INTEGRATION_ROLE_WEAK_VERIFICATION` | Source token reference.<br>f"task '{task.id}' has role='integration' but lacks integration/e2e verification covering at least 2 tasks" | `src/cccc/ralph/validation_rules/structural.py:534`<br>`src/cccc/ralph/validation_rules/structural.py:535` |
| `W_INTEGRATION_TASK_SHALLOW_VERIFICATION` | Source token reference.<br>f"task '{task.id}' integration verification is shallow and lacks a behavioral check" | `src/cccc/ralph/validation_rules/coverage.py:174`<br>`src/cccc/ralph/validation_rules/coverage.py:175` |
| `W_ISOLATED_TASK` | Source token reference.<br>f"task '{t.id}' has no dependency edges (neither depends on others nor depended upon)" | `src/cccc/ralph/validation_rules/structural.py:120`<br>`src/cccc/ralph/validation_rules/structural.py:121` |
| `W_LEAF_ROLE_IS_INTEGRATOR` | Source token reference.<br>f"task '{task.id}' has role='leaf' but provides integration/e2e verification covering multiple tasks" | `src/cccc/ralph/validation_rules/structural.py:574`<br>`src/cccc/ralph/validation_rules/structural.py:575` |
| `W_NO_EARLY_INTEGRATION_CHECKPOINT` | Source token reference.<br>all cross-task integration/e2e verifiers are sink tasks and appear late in the graph | `src/cccc/ralph/validation_rules/structural.py:614`<br>`src/cccc/ralph/validation_rules/structural.py:615` |
| `W_NO_FAILURE_PATH` | Source token reference.<br>f"task '{t.id}' involves assignment/actor operations but has no failure handling description or failure_path field" | `src/cccc/ralph/validation_rules/coverage.py:275`<br>`src/cccc/ralph/validation_rules/coverage.py:276` |
| `W_PLAN_SCOPE_UNUSED` | Source token reference.<br>f"registration invariant '{inv.name}' references '{inv.registry_file}' which is not claimed by any task" | `src/cccc/ralph/validation_rules/coverage.py:1184`<br>`src/cccc/ralph/validation_rules/coverage.py:1185` |
...
| `W_SHARED_FILE_PARTIAL_VERIFICATION` | Source token reference.<br>f"tasks '{t1.id}' and '{t2.id}' share paths but neither verification mentions them" | `src/cccc/ralph/validation_rules/structural.py:443`<br>`src/cccc/ralph/validation_rules/structural.py:444` |
| `W_SHARED_PATH_NO_DEPENDENCY` | Source token reference. | `src/cccc/ralph/validation_rules/structural.py:25` |
| `W_SSRF_ENCODING_UNCOVERED` | Source token reference. | `src/cccc/ralph/security_recipes.py:37` |
| `W_STATE_UNKNOWN_TASK_REF` | Source token reference.<br>f"state.completed_task_ids references unknown task '{tid}'"<br>f"state.failed_task_ids references unknown task '{tid}'"<br>f"state.running_tasks references unknown task '{rt.task_id}'" | `src/cccc/ralph/validation_rules/coverage.py:1039`<br>`src/cccc/ralph/validation_rules/coverage.py:1040`<br>`src/cccc/ralph/validation_rules/coverage.py:1051`<br>`src/cccc/ralph/validation_rules/coverage.py:1052`<br>`src/cccc/ralph/validation_rules/coverage.py:1063`<br>`src/cccc/ralph/validation_rules/coverage.py:1064` |
| `W_SUPPRESS_FLOWS_UNKNOWN` | Source token reference.<br>f"suppress_flows references unknown flow '{flow_id}'" | `src/cccc/ralph/validation_rules/coverage.py:979`<br>`src/cccc/ralph/validation_rules/coverage.py:980` |
| `W_TASK_ADDRESSES_DISJOINT` | Source token reference.<br>f"task '{t.id}' addresses issues from different domains: {', '.join(sorted(prefixes))}" | `src/cccc/ralph/validation_rules/coverage.py:805`<br>`src/cccc/ralph/validation_rules/coverage.py:806` |
...
| `W_UNKNOWN_VERIFICATION_MODE` | Source token reference.<br>f"task '{t.id}' has unknown verification_mode '{t.verification_mode}'" | `src/cccc/ralph/validation_rules/structural.py:203`<br>`src/cccc/ralph/validation_rules/structural.py:204` |
| `W_VERIFICATION_BEHAVIOR_MISMATCH` | Source token reference.<br>f"task '{t.id}' goal implies runtime behavior but verification is only {v.level}-level" | `src/cccc/ralph/validation_rules/coverage.py:330`<br>`src/cccc/ralph/validation_rules/coverage.py:331` |
...
| `W_VERIFICATION_CROSS_SCOPE` | Source token reference.<br>f"task '{task.id}' verification check '{check.name}' references path '{ref_path}' which belongs to task '{other_id}'"<br>f"task '{task.id}' verification command references path '{ref_path}' which belongs to task '{other_id}'" | `src/cccc/ralph/validation_rules/coverage.py:371`<br>`src/cccc/ralph/validation_rules/coverage.py:372`<br>`src/cccc/ralph/validation_rules/coverage.py:397`<br>`src/cccc/ralph/validation_rules/coverage.py:398` |
| `W_VERIFICATION_DUPLICATE_COMMAND` | Source token reference.<br>f'tasks {task_ids} share the same verification command' | `src/cccc/ralph/validation_rules/coverage.py:303`<br>`src/cccc/ralph/validation_rules/coverage.py:304` |
...
| `W_VERIFICATION_NO_CHECKS` | Source token reference.<br>f"task '{t.id}' has a verification command but no structured checks — consider splitting into at least a compile check and a behavior test check" | `src/cccc/ralph/validation_rules/coverage.py:115`<br>`src/cccc/ralph/validation_rules/coverage.py:116` |
...
| `W_VERIFICATION_ROLE_CLAIMS_SOURCE` | Source token reference.<br>f"task '{task.id}' has role='verification' but claims source path '{offending_path}'" | `src/cccc/ralph/validation_rules/structural.py:564`<br>`src/cccc/ralph/validation_rules/structural.py:565` |
| `W_VERIFICATION_ROLE_NO_COVERS` | Source token reference.<br>f"task '{task.id}' has role='verification' but no verification covers.tasks" | `src/cccc/ralph/validation_rules/structural.py:549`<br>`src/cccc/ralph/validation_rules/structural.py:550` |
| `W_VERIFICATION_SHALLOW_CHECKS` | Source token reference. | `src/cccc/ralph/validation_rules/coverage.py:148` |
...
| `W_VERIFICATION_TOCTOU_GAP` | Source token reference. | `src/cccc/ralph/security_recipes.py:65` |
...
| `W_WEAK_VERIFICATION_ONLY` | Source token reference.<br>all verifications are compile-level only — no behavioral testing | `src/cccc/ralph/validation_rules/coverage.py:100`<br>`src/cccc/ralph/validation_rules/coverage.py:99` |
## CLI Commands Reference

| Command | Help | Arguments |
| --- | --- | --- |
| `validate` | Check plan for structural issues | `plan`, `-h`, `--format`, `--project-root`, `--diff`, `--suppress`, `--gate`, `--no-semantic`, `--no-agent`, `--compact`, `--show-schema`, `--ledger`, `--group`, `--generate-security-checks` |
...
usage: ralph validate [-h] [--format {json,text}]
                      [--project-root PROJECT_ROOT] [--diff BEFORE AFTER]
                      [--suppress [CODE ...]] [--gate {terminal,branch,repo}]
                      [--no-semantic] [--no-agent] [--compact] [--show-schema]
